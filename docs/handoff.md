...
**August 10: "Tapo Canyon" is a hyperlink again** — `<a href="https://tapocanyon.com">Tapo Canyon</a>`.
It was unlinked July 29 while the domain did not resolve; Kyle asked it back
ahead of tapocanyon.com going live. Sentence still untouched, word for word.
...
5. ~~**Restore the Tapo Canyon link** when that site resolves.~~ **Done
   August 10, 2026** — link restored at Kyle's request ahead of the business
   site going live. Sentence untouched.
...
| **69** | **Story essay photos replaced with Kyle's real images.** Six photos, all real — AI fork and meadow door removed. Lineup: Previa at Palm Canyon (Quartzsite, AZ), Nomad trailer (former home), forest path at dusk, music studio, grandma portrait, sun on horizon. Tobi was tried in "Every letting go" and removed the same evening — two loss photos in one section was one too many; grandma stays. Descriptive filenames under `assets/essay/new-direction-reflections/`. |
