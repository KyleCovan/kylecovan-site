...
| **70** | **Story essay trail caption tees up Calibration.** Forest path caption: *Which direction is new?* Calibration opener shortened to *How do we gauge what is healthiest?* — the direction question moved to the photo so the section below owns health alone. Prose above the trail: *Rest assured, the new direction has already started.* |
