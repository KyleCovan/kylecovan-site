...
outline:
  ...
  - lead: How it works today
    rest: the tools it connects, what it watches, what it surfaces to me and when.
  - lead: What it caught
    rest: concrete examples of an opportunity flagged or a bottleneck spotted early.
  - lead: What broke
    rest: the versions that failed and what I changed.
  - lead: Where it goes next
    rest: the next capability I'm adding.
---
