...
prompts:
  ...
  - lead: How it's structured
    rest: ingestion, indexing, and how I actually retrieve things.
  - lead: Retrieval in practice
    rest: a real question asked and the answer it returned.
  - lead: What I'd do differently
    rest: lessons from the first architecture.
  - lead: Where it goes next
    rest: the next source or capability I'm wiring in.
---
