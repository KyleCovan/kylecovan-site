<!-- Source: src/content/writing/mailto-beat-the-mail-menu.md · UNPOSTED · queued 2026-08-10 -->
...
A choice that looks considerate can be friction when the default already works. Test the path a real person takes, not the path that looks complete in a wireframe.
